...
//				Debug.Log (AwesomeObject.StartPosition);
				...
				GameObject OurSpecialNucleosome = Nucleosome.CreateNucleosome (TimeStep [i + 1], Convert.ToInt32 (TimeStep [i + 2]), Convert.ToInt32 (TimeStep [i + 3]));
...
//				yield return instance.StartCoroutine_Auto (instance.JustWait ());
			...
			if (TimeStep [i] == "Transcription_Factor") {
				...
				GameObject OurSpecialTransFactor = TranscriptionFactor.CreateTranscriptionFactor (TimeStep [i + 1], Convert.ToInt32 (TimeStep [i + 2]), Convert.ToInt32 (TimeStep [i + 3]));
...
//				yield return instance.StartCoroutine_Auto (instance.JustWait ());
			...
			if (TimeStep [i] == "Transcriptional_Machinery") {
				...
				GameObject OurSpecialTransMach = TranscriptionalMachinery.CreateTranscriptionalMachinery (TimeStep [i + 1], Convert.ToInt32 (TimeStep [i + 2]), Convert.ToInt32 (TimeStep [i + 3]));
